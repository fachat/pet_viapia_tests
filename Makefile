...
PRG5    = $(BUILD)/05_test1
PRG6    = $(BUILD)/06_userport_test1
PRG7    = $(BUILD)/07_userport_test2
...
LST6    = $(LISTING)/06_userport_test1.lst
LST7    = $(LISTING)/07_userport_test2.lst
...
$(PRG6): 06_userport_test1.a65 | $(BUILD) $(LISTING)
	$(XA) $(XAFLAGS) -o $@ -P $(LST6) $<

$(PRG7): 07_userport_test2.a65 | $(BUILD) $(LISTING)
	$(XA) $(XAFLAGS) -o $@ -P $(LST7) $<
...
run6: $(PRG6)
	bash vice/run_06_userport_test1.sh

# Run pet_userport_test2 in VICE (PET 4032)
run7: $(PRG7)
	bash vice/run_07_userport_test2.sh
