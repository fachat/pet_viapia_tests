...
#
# After running this script, run run-04-via-test1.sh (or 'make run4') to
# execute the test against the generated data.
#
# Usage: bash vice/run-04-via-test1-gen.sh <d64_image> [extra VICE options]
...
exec xpet -model 4032 \
     -8 "$D64" \
     -keybuf $'load"04-via-test1-gen",8,1\nrun\n' \
     "$@"
