...
#
# The D64 disk image (populated with reference data by run-04-via-test1-gen.sh)
...
#           Reference data in the D64 image (run run-04-via-test1-gen.sh first)
# Usage: bash vice/run-04-via-test1.sh <d64_image> [extra VICE options]
