...
#
# The D64 disk image (populated with reference data by run_05_test1_gen.sh)
...
#           Reference data in the D64 image (run run_05_test1_gen.sh first)
# Usage: bash vice/run_05_test1.sh <d64_image> [extra VICE options]
