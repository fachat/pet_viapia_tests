...
#
# The D64 disk image (populated with reference data by run_08_sr_test_gen.sh)
...
#           Reference data in the D64 image (run run_08_sr_test_gen.sh first)
# Usage: bash vice/run_08_sr_test.sh <d64_image> [extra VICE options]
