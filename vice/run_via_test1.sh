...
#
# The D64 disk image (populated with reference data by run_via_test1_gen.sh)
...
#           Reference data in the D64 image (run run_via_test1_gen.sh first)
# Usage: bash vice/run_via_test1.sh <d64_image> [extra VICE options]
